...
namespace _500pxWin8SampleApp
{
    public class Guests
    {
        ...
        [DataMember(Name = "guestName")]
        public string GuestName { get; set; }

        [DataMember(Name = "guestEmail")]
    ...
    public class GuestsDataAccess
    {
        ...
        private ObservableCollection<Guests> items;

        private IMobileServiceTable<Guests> mobileServiceTable = App.MobileService.GetTable<Guests>();

        public async Task<int> Insert(Guests item)
        {
        ...
        public async void Update(Guests item)
        {
        ...
        public async void Delete(Guests item)
        {
            // This code takes a freshly completed Events and updates the database. When the MobileService 
            // responds, the item is removed from the list 
        ...
        public async Task<ObservableCollection<Guests>> Get()
        {
            var results = await mobileServiceTable.ToListAsync();
            items = new ObservableCollection<Guests>(results.ToList());
            return items;
        }
